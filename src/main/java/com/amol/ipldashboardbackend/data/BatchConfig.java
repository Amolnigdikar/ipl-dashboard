package com.amol.ipldashboardbackend.data;
...
public class BatchConfig {
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id,city,date,player_of_match,venue,neutral_venue,team1, team2,toss_winner,toss_decision,match_winner,result,result_margin,"
                        + "eliminator,method,umpire1,umpire2) VALUES (:id,:city,:date,:playerOfMatch,:venue,:neutral_venue,:team1,"
                        + ":team2,:tossWinner,:tossDecision,:matchWinner,:result,:resultMargin,:eliminator,:method,:umpire1,:umpire2)")
